...
def DataUploader():
    ...
    for i in trimid:
        ...
        # print((int(i)))
        # print(int(frontTire.split('/')[0]))
        # print(int(frontTire.split('/')[1].split('R')[0]))
        # print(int(frontTire.split('/')[1].split('R')[1]))
        # print(int(rearTire.split('/')[0]))
        # print(int(rearTire.split('/')[1].split('R')[0]))
        # print(int(rearTire.split('/')[1].split('R')[1]))
